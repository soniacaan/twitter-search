...
fields = "id tweet_id status screen_name name created_at url followers_count friends_count statuses_count \
...
for entry in users:
    ...
    r['id'] = entry['id']
    r['tweet_id'] = entry['status']['id']
    r['status'] = entry['status']['text']
